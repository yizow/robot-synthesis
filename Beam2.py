...
class Beam():
    ...
    def __init__(self, length, PoIOffset = 0.0, PoIDistance = 0.0):
        ...
        self.PoIOffset = float(PoIOffset)
        self.PoIDistance = float(PoIDistance)
    ...
    def end(self):
        return travel(self.position, self.rotation[0], self.length)
    ...
    def PoI(self):
        intersect = travel(self.position, self.rotation[0], self.PoIOffset*self.length)
